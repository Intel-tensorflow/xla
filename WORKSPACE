...
http_archive(
    ...
    build_file = "//third_party/gpus/sycl/hermetic:sycl_hermetic.BUILD",
)
...
http_archive(
    ...
    build_file = "//third_party/gpus/sycl/hermetic:level_zero_redist.BUILD",
)
...
http_archive(
    ...
    build_file = "//third_party/gpus/sycl/hermetic:ze_loader_redist.BUILD",
)
